...
import com.example.vagmobile1.ui.adapter.AdminArtworkAdapter;
import com.example.vagmobile1.viewmodel.AdminArtworkViewModel;
...
public class AdminArtworksActivity extends AppCompatActivity {
    ...
    private com.example.vagmobile1.model.User parseUserFromArtworkData(Map<String, Object> artworkData) {
        com.example.vagmobile1.model.User user = new com.example.vagmobile1.model.User();
